...
internals.keySecretScheme = function(server, options) {
    ...
    settings.appKey = settings.appKey || 'KeySecret Key';
    ...
    var scheme = {
        authenticate: function(request, reply) {
            ...
            // Reformat to Hawk
            request.raw.req.headers.authorization = request.raw.req.headers.authorization.replace(settings.appKey + '=', 'Hawk id=');
