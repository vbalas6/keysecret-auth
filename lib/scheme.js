...
internals.keySecretScheme = function(server, options) {
    ...
    settings.schemeName = settings.schemeName || 'KeySecret';
    ...
    var scheme = {
        authenticate: function(request, reply) {
            ...
            // Reformat to Hawk
            request.raw.req.headers.authorization = request.raw.req.headers.authorization.replace(settings.schemeName + ' key=', 'Hawk id=');
...
internals.bewit = function(server, options) {
    ...
    var scheme = {
        authenticate: function(request, reply) {
            ...
            // Reformat to Hawk
            request.raw.req.headers.authorization = request.raw.req.headers.authorization.replace(settings.appKey + ' key=', 'Hawk id=');
